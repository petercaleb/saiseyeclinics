...
class LensPower1 extends Model
{
    use HasFactory;

    protected $table = 'lens_powers_1';
    ...
    {
        # code...
        return $this->hasOne(LensPrescription1::class, 'power_id', 'id');
    }
    ...
    {
        return $this->hasOne(Treatment1::class, 'power_id', 'id');
    }
}
