                    ...
                    @if ($treatment)
                        ...
                        @else
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="openBillFrameAmount">
                                            Frame Amount
                                        </label>
                                        <input type="text" class="form-control" name="frame_amount"
                                            id="openBillFrameAmount" placeholder="Frame Amount">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="openBillLensAmount">
                                            Lens Amount
                                        </label>
                                        <input type="text" class="form-control" name="lens_amount"
                                            id="openBillLensAmount" placeholder="Lens Amount">
                                    </div>
                                </div>
                            </div>
                            <!--.row-->
